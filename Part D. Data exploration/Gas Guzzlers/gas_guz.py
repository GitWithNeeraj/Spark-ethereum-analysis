...
if __name__ == "__main__":
    ...
    avg_gas_used = avg_gas_used.sortByKey(ascending = True)
    ...
    my_result_object = my_bucket_resource.Object(s3_bucket,'ethereum_partd3_1_' + date_time + '/av_gasprice.txt')
    my_result_object.put(Body=json.dumps(average_gas_price.take(100)))               
    my_result_object1 = my_bucket_resource.Object(s3_bucket,'ethereum_partd3_1_' + date_time + '/av_gasused.txt')
