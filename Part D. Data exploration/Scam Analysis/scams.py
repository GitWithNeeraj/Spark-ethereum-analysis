...
if __name__ == "__main__":
    ...
    my_result_object = my_bucket_resource.Object(s3_bucket,'ethereum_partd1_' + date_time + '/lucrative_scams.txt')
    my_result_object.put(Body=json.dumps(top10_ps))               
    my_result_object = my_bucket_resource.Object(s3_bucket,'ethereum_partd1_' + date_time + '/time_data.txt')
